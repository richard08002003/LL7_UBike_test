...
int main()
{
    ...
    fp2 = fopen( "/home/root/LL7_Test/Log/Repeat_data_Test.log" , "r" ) ;
    //fp2 = fopen( "/home/richard/Richard/UBike_LL7_test/LL7_Auto_test/TestLog/Repeat.log" , "r" ) ;
    if ( fp2 == NULL ) {
        printf("檔案開啟失敗！\n") ;
        exit(1) ;
    }
    ...
    fprintf( fp1 , "%s" , "Repeat_Data_test Parser . . .\n" ) ;
    fflush(fp1) ;
      ...
      if ( Ss == 6 ) {
            if ( Rs == 6 ) {
                if ( Rtn == 6 ) {
                    ...
                    fprintf( fp1 , "%d\n" , Rtn ) ;
                    fflush(fp1) ;
                    printf("<<< Repeat Data Test Success >>> \n") ;
                    printf("-------------------------------\n") ;
                    fprintf( fp1 , "%s" , "<<< Repeat Data Test Success >>> \n" ) ;
                    fflush(fp1) ;
                }
            }
        } else {
        ...
        printf("<<< Repeat_Data Test Failed >>> \n") ;
        printf("-------------------------------\n") ;
        fprintf( fp1 , "%s" , "<<< Repeat_Data Test Failed >>> \n" ) ;
        fflush(fp1) ;
    }
    fprintf(fp1 , "%s" , "---------------------------------------\n" ) ;
    fflush(fp1) ;
