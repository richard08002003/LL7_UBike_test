...
int main()
{
    ...
    fp2 = fopen( "/home/root/LL7_Test/Log/Api_Test.log" , "r" ) ;
    //fp2 = fopen( "/home/richard/Richard/UBike_LL7_test/LL7_Auto_test/TestLog/Api.log" , "r" ) ;
    if ( fp2 == NULL ) {
        printf("檔案開啟失敗！\n") ;
        exit(1) ;
    }
      ...
      if ( Ss == 12 ) {
            if ( Rs == 12 ) {
                if ( Rtn == 12 ) {
                    ...
                    printf("-------------------------------\n") ;
                    fprintf( fp1 , "%s" , "<<< Api Test Success >>> \n" ) ;
                    fflush(fp1) ;
                }
            }
        } else {
